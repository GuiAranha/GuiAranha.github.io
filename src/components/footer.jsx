...
export default function Footer() {
  return (
    <div class="w-auto h-[200px] flex items-center justify-center bg-neutral-900">
        <div class="md:w-2/3 w-full px-4 text-white flex flex-col">
            <div class="flex flex-col">
                <hr class="border-gray-600"/>
                <p class="label mx-auto block text-center w-[320px] my-5 text-gray-600 flex">
                  <p class="h-auto w-auto pr-1">Created with</p>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="inline-block w-4 h-4 text-white">
                    <path fill="#00acc1"
                      d="M24,9.604c-6.4,0-10.4,3.199-12,9.597c2.4-3.199,5.2-4.398,8.4-3.599 c1.826,0.456,3.131,1.781,4.576,3.247C27.328,21.236,30.051,24,36,24c6.4,0,10.4-3.199,12-9.598c-2.4,3.199-5.2,4.399-8.4,3.6 c-1.825-0.456-3.13-1.781-4.575-3.247C32.672,12.367,29.948,9.604,24,9.604L24,9.604z M12,24c-6.4,0-10.4,3.199-12,9.598 c2.4-3.199,5.2-4.399,8.4-3.599c1.825,0.457,3.13,1.781,4.575,3.246c2.353,2.388,5.077,5.152,11.025,5.152 c6.4,0,10.4-3.199,12-9.598c-2.4,3.199-5.2,4.399-8.4,3.599c-1.826-0.456-3.131-1.781-4.576-3.246C20.672,26.764,17.949,24,12,24 L12,24z" />
                  </svg>
                  <p class="h-auto w-auto px-1">and</p>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" class="inline-block w-4 h-4 text-white">
                      ...
                      <path fill="#4e7ab5" d="M20,24c-2.206,0-4-1.794-4-4s1.794-4,4-4s4,1.794,4,4S22.206,24,20,24z M20,17c-1.654,0-3,1.346-3,3 s1.346,3,3,3s3-1.346,3-3S21.654,17,20,17z"></path><path fill="#8bb7f0" d="M20,28.068C9.346,28.068,1,24.524,1,20s8.346-8.068,19-8.068S39,15.476,39,20 S30.654,28.068,20,28.068z M20,12.932c-9.757,0-18,3.237-18,7.068s8.243,7.068,18,7.068S38,23.832,38,20S29.757,12.932,20,12.932z"></path>
                ...
                <div class="flex justify-center items-center pb-[50px] md:hidden">
                  ...
                  <div class="px-5">
                    <a target="_blank" rel="noreferrer" href="https://github.com/GuiAranha" class="">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="w-8 h-8 text-white">
                        <path fill="currentColor"
